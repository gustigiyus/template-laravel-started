        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="form-modal p-4 md:p-5">
                <div class="flex flex-col gap-4 mb-4">
                    <div class="mb-3">
                        <x-input-label for="role_name" class="label-alert-role_name" :value="__('Role Name')" />
                        <x-text-input id="role_name" class="block w-full input-alert-role_name" type="text"
                            name="role_name" placeholder="Type role name" required autofocus autocomplete="off" />
                        <x-input-error-v2 class="msg-alert-role_name"></x-input-error-v2>
                    </div>
                    <div class="mb-3">
                        <x-input-label for="role_desc" class="label-alert-role_desc" :value="__('Role Description')" />
                        <x-textarea-input id="role_desc"
                            class="input-alert-role_desc block w-full p-2.5 text-sm rounded-lg" rows="4"
                            name="role_desc" placeholder="Type role description" autocomplete="off"></x-textarea-input>
                        <x-input-error-v2 class="msg-alert-role_desc"></x-input-error-v2>
                    </div>
                </div>
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <form action="{{ route('roleDelete') }}" method="post">
                    ...
                    <h3 class="mb-5 text-md font-normal text-gray-500 dark:text-gray-400">Are you sure you want to
                        delete?
                        <br>
                        Roles: <span class="deleted-text font-bold"></span>
                    </h3>
                    <button type="submit"
