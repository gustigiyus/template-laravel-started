                            ...
                            <div class="flex flex-col xl:flex-row lg:flex-row md:flex-row mb-4 gap-5">
                                <div class="w-full sm:col-span-3">
                                    ...
                                    <x-text-input id="username" class="block w-full input-alert-username"
                                        type="text" name="username" placeholder="Type username" required autofocus
                                        autocomplete="off" value="{{ $usr->username }}" />
                                ...
                                <div class="w-full sm:col-span-3">
                                    ...
                                    <x-text-input id="name" class="block w-full input-alert-name" type="numeric"
                                        name="name" placeholder="Type full name" required autofocus
                                        autocomplete="off" value="{{ $usr->user_detail->name }}" />
                            ...
                            <div class="flex flex-col xl:flex-row lg:flex-row md:flex-row mb-4 gap-5">
                                <div class="w-full sm:col-span-3">
                                    ...
                                    <x-text-input id="password" class="block w-full input-alert-password"
                                        type="text" name="password" placeholder="Type password" required autofocus
                                        autocomplete="off" />
