        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form class="form-modal p-4 md:p-5">
                <div class="flex flex-col gap-4 mb-4">
                    <div class="mb-3">
                        <x-input-label for="menu_name" class="label-alert-menu_name" :value="__('Menu Name')" />
                        <x-text-input id="menu_name" class="block w-full input-alert-menu_name" type="text"
                            name="menu_name" placeholder="Type menu name" required autofocus autocomplete="off" />
                        <x-input-error-v2 class="msg-alert-menu_name"></x-input-error-v2>
                    </div>
                    <div class="mb-3">
                        <x-input-label for="menu_desc" class="label-alert-menu_desc" :value="__('Menu Description')" />
                        <x-textarea-input id="menu_desc"
                            class="input-alert-menu_desc block w-full p-2.5 text-sm rounded-lg" rows="4"
                            name="menu_desc" placeholder="Type menu description" autocomplete="off"></x-textarea-input>
                        <x-input-error-v2 class="msg-alert-menu_desc"></x-input-error-v2>
                    </div>
                </div>
